...
#Links - 
- https://piotrminkowski.com/2018/04/26/quick-guide-to-microservices-with-spring-boot-2-0-eureka-and-spring-cloud/comment-page-1/#comment-3572

#Best Links - 

- https://dzone.com/articles/spring-boot-microservices-2
...
Run 1) config-server  2) discovery-server  3) proxy-server then run all other services

Please do not run the gateway-service, because Swagger SpringFox didn't support reactive with Spring WebFlux in the time I have been writing that article. Please run proxy-service which is based on Zuul, 
